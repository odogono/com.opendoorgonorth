...
summary: Games for an interactive installation
date: ['2003', '2003']
tags: [ game, 'Macromedia Director', mobile ]
---
...
An interactive outdoor 4 x 4 metre display which was deployed at the Vodafone 
...
We were contracted to develop two games for the cube, working with IDEO designers 
...
forward commands from incoming [DTMF](https://en.wikipedia.org/wiki/Dual-tone_multi-frequency_signaling).
