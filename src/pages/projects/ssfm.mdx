...
summary:  A massively multiplayer online football management sim
date: ['1999', '2002']
tags: [ game, mmpog, java ]
---


**Client:** HotGen Studios Ltd, Croydon, UK

![You'll never play alone](file:///media/ssfm.jpg)
...
SSFM was an evolution of the codebase and experience in multiplayer online games that had 
begun with DOTN. 
The architecture of the system was what would now be thought of as [Microservices](https://martinfowler.com/articles/microservices.html). 
...
albeit a single running executable. Because certain parts were written in different languages, 
this led to using a Microservices based approach. This also had the benefit of being able to scale 
