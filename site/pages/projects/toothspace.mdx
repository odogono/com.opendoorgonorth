...
A proof of concept system was implemented soon after which allowed passing bluetooth devices to be tracked, make a good guess at determining the handset type, and to send messages or images to it. 
